        ...
        <div className="relative overflow-hidden rounded-[12px] bg-gradient-to-br from-[#5CA0D3] to-[#87CEEB] px-8 py-16 md:py-24 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 w-full">
              ...
              {/* Clinician Button */}
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white text-[#5CA0D3] hover:bg-gray-50 text-[15px] font-bold px-8 py-4 rounded-xl shadow-md transition-all transform hover:-translate-y-0.5">
              ...
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#5CA0D3] text-[15px] font-bold px-8 py-4 rounded-xl transition-all transform hover:-translate-y-0.5">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
